...
class SearchAPI:
    ...
    def build_manifest(self, request, response):
    ...
    def search(self):
        ...
        if generate_manifest is True:
            return self.build_manifest(request, response)
    ...
    def reindex(self, uuid, priority=None):
        ...
        if self.JOB_QUEUE_MODE == True:
            if priority is not None:
                ...
                priority = 1
            try:
                reference_id = translator.enqueue_reindex(uuid, self.reindex_queue, priority, job_type='LIVE')
